...
const chartConfig = {
  visitors: { label: "Visites" },
  desktop: { label: "Ordinateur", color: "var(--chart-1)" },
  mobile:  { label: "Mobile",     color: "var(--chart-2)" },
}

export default function DeviceChart() {
  const [timeRange, setTimeRange] = React.useState("90 jours")
  ...
  return (
    /* ↓ wrapper qui active le thème localement */
    <div className="gespeed-charts">
      <Card className="pt-0 bg-white ">
        <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
          <div className="grid flex-1 gap-1">
            <CardTitle>Visite des utilisateurs</CardTitle>
            <CardDescription>Répartition des visites sur les 3 derniers mois selon les appareils</CardDescription>
          </div>
          <Select value={timeRange} onValueChange={setTimeRange}>
            <SelectTrigger className="hidden w-[160px] rounded-lg sm:ml-auto sm:flex" aria-label="Sélectionner une période">
            ...
            <AreaChart data={filteredData}>
              <defs>
                ...
                <linearGradient id="fillMobile" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%"  stopColor="var(--color-mobile)" stopOpacity={0.85} />
